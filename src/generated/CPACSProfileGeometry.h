...
namespace generated
{
    ...
    public:
        ...
        TIGL_EXPORT virtual const boost::optional<CCPACSCurvePointListXYZ>& GetPointList_choice1() const;
        TIGL_EXPORT virtual boost::optional<CCPACSCurvePointListXYZ>& GetPointList_choice1();
