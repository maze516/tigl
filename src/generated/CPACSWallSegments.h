...
namespace generated
{
    ...
    private:
        ...
        CPACSWallSegments& operator=(const CPACSWallSegments&) = delete;

        CPACSWallSegments(CPACSWallSegments&&) = delete;
        CPACSWallSegments& operator=(CPACSWallSegments&&) = delete;
    };
} // namespace generated
