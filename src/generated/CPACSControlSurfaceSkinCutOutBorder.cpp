...
namespace generated
{
    CPACSControlSurfaceSkinCutOutBorder::CPACSControlSurfaceSkinCutOutBorder(CCPACSControlSurfaceWingCutOut* parent)
    {
        //assert(parent != NULL);
        m_parent = parent;
    }
    ...
    void CPACSControlSurfaceSkinCutOutBorder::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
    {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/etaLE")) {
            m_etaLE_choice2 = boost::in_place(this);
            try {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/etaTE")) {
            m_etaTE_choice2 = boost::in_place(this);
            try {
